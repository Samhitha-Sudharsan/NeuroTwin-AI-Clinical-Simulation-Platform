# NeuroTwin AI: The Clinical Digital Twin for Neuro-Rehab

## 1. The Problem
*   **The Guesswork in Neurological Rehabilitation:** Currently, treating complex conditions like Functional Neurological Disorder (FND) or post-stroke motor deficits relies heavily on trial-and-error behavioral therapies.
*   **Lack of Objective Data:** Clinical teams (Physical Therapists, BCBAs, Neurologists) have no real-time, objective way to measure how an external behavioral intervention (like CBT or physical therapy) is structurally rewiring the patient's brain (neuroplasticity).
*   **The Wearable Limit:** Current consumer wearables track basic biometrics (heart rate, movement), but they do not map actions back to brain state or predict the optimal clinical intervention.
...
*   **B2B SaaS / Medical Device:** Sold as Software as a Medical Device (SaMD) via an annual subscription to hospitals.
*   **Revenue Streams:** 
    *   Hardware installation (Ambient sensor suite)
    *   SaaS licensing per bed/patient
    *   Data licensing for pharmacological research in neuroplasticity
